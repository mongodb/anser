...
func (c *Collection) UpdateOne(ctx context.Context, query, update interface{}, opts ...options.Lister[options.UpdateOptions]) (*client.UpdateResult, error) {
	return &c.UpdateResult, nil
}

func (c *Collection) UpdateMany(ctx context.Context, query, update interface{}, opts ...options.Lister[options.UpdateOptions]) (*client.UpdateResult, error) {
	return &c.UpdateResult, nil
}
